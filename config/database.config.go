...
import (
	...
	"github.com/luongdinhkhanhvinh/golang_heroku/entity"
...
func SetupDatabaseConnection() *gorm.DB {
	...
	dsn := fmt.Sprintf("host=%s user=%s password=%s port=%s dbname=%s TimeZone=Asia/Shanghai", dbHost, dbUser, dbPass, dbPort, dbName)
